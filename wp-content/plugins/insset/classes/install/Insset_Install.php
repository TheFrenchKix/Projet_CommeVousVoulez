...
class Insset_Install {
    ...
    if(dbDelta($sql_config)){
        $wpdb->insert($wpdb->prefix.INSSET_BASENAME.'_config', array('id'=> 'DateOuverture', 'valeur'=> '2023-01-01 00:00', 'description'=> 'Date Ouverture', 'rank'=>10));            
        $wpdb->insert($wpdb->prefix.INSSET_BASENAME.'_config', array('id'=> 'DateFermeture','valeur'=> '2023-12-30 23:59', 'description'=> 'Date Fermeture', 'rank'=>20));
